...
export interface Note {
    ...
    step: number;
    color?: string;
    shape?: 'rectangle' | 'hexagon' | 'folder';
    owner?: Group;
}
...
export class SequenceDiagram implements Diagram {
    ...
    addNote(text: string, position: 'left' | 'right' | 'over' | 'across', participants: string[], color?: string, shape: 'rectangle' | 'hexagon' | 'folder' = 'folder', step?: number) {
