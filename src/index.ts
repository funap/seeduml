...
/**
 * Automatically render all nanouml diagram blocks on the page
 * @param selector CSS selector for diagram blocks (default: 'pre.nanouml')
 */
export function renderAll(selector: string = 'pre.nanouml'): void {
...
/**
 * Initialize NanoUML with automatic rendering
