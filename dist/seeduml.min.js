...
`).map((c,r)=>`<tspan x="10" dy="${r===0?0:"1.3em"}">${this.escapeXml(c)}</tspan>`).join("")}
        ...
        `}};function Q(I){let i=new st,t=new at;try{let e=i.parse(I);return t.render(e)}catch(e){return bt(e)}}function J(I){let i=new lt,t=new dt;try{let e=i.parse(I);return t.render(e)}catch(e){return bt(e)}}function bt(I){let t=(I.message||"Unknown error occurred during parsing").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),e=800,n=100;return`
    ...
    `.trim()}function pt(I){let i=/\b(participant|actor|boundary|control|entity|collections|queue)\b/.test(I),t=/\b(component|package|node|cloud|database|frame|folder)\b/.test(I),e=/^\s*\[[^\]]+\]/m.test(I),n=t||e,o=i;return o&&!n?Q(I):n&&!o?J(I):/\b(alt|else|loop|group|note|opt|par|break|critical|ref)\b/.test(I)?Q(I):e?J(I):Q(I)}function tt(I="pre.seeduml"){if(typeof document>"u")return;document.querySelectorAll(I).forEach(t=>{let e=t.textContent||"",n=pt(e),o=document.createElement("div");o.className="seeduml-diagram",o.innerHTML=n,o.style.display="inline-block",t.parentNode?.replaceChild(o,t)})}function $t(I={}){let{startOnLoad:i=!0,selector:t="pre.seeduml"}=I;i&&(typeof document>"u"||(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{tt(t)}):tt(t)))}typeof window<"u"&&(window.seeduml={renderSequenceDiagram:Q,renderComponentDiagram:J,render:pt,renderAll:tt,initialize:$t});var Rt={renderSequenceDiagram:Q,renderComponentDiagram:J,render:pt,renderAll:tt,initialize:$t};return Ct(Et);})();
